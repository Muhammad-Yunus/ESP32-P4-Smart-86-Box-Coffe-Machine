...
lv_anim_t * scrollleft_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * scroll_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_time(&PropertyAnimation_0, 125);
    ...
    lv_anim_set_time(&PropertyAnimation_1, 375);
    ...
    lv_anim_set_delay(&PropertyAnimation_1, delay + 125);
